...
class Home extends Component
{
    ...
    protected $menuItems = [
        'dashboard' => [
            ...
            'description' => 'Comprehensive overview of your exam management system.'
        ],
        'basic' => [
            'label' => 'Basic',
            ...
            'subitems' => [
                ...
                'subject-types' => [
                    ...
                    'description' => 'Manage subject types and categories for organizing subjects.'
                ],
                'subjects' => [
                    'label' => 'Subjects',
                    'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
                    'component' => 'subject-comp',
                    'description' => 'Manage school subjects with types and configurations.'
                ],
                'myclass-subjects' => [
                    ...
                    'description' => 'Assign subjects to classes with ordering and configuration.'
                ],
                'teachers' => [
                    'label' => 'Teachers',
                    'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z',
                    'component' => 'teacher-comp',
                    'description' => 'Manage teaching staff with categories and qualifications.'
                ],
                'subject-teachers' => [
                    'label' => 'Subject Teachers',
                    'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253M9 12l2 2 4-4',
                    'component' => 'subject-teacher-comp',
                    'description' => 'Assign teachers to subjects and manage subject-wise teaching assignments.'
                ]
            ]
        ],
        ...
        'students' => [
            ...
            'subitems' => [
                'student-database' => [
                    ...
                    'description' => 'Comprehensive student database with 4-step registration and document management.'
                ]
            ]
        ],
        'exams' => [
        ...
        'settings' => [
            ...
            'subitems' => [
                'sessions' => [
                    'label' => 'Sessions',
                    'icon' => 'M8 7V3a4 4 0 118 0v4m-4 6v6m-4-6h8m-8 0a2 2 0 00-2 2v4a2 2 0 002 2h8a2 2 0 002-2v-4a2 2 0 00-2-2',
                    'component' => 'session-comp',
                    'description' => 'Manage academic sessions and set active session.'
                ],
                ...
                'user-roles' => [
                    ...
                    'description' => 'Configure user roles and permissions with proper hierarchy control.'
                ],
            ]
        ],
        'analytics' => [
