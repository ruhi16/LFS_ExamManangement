    ...
    <div class="flex h-[calc(100vh_-_72px)] bg-gray-100 overflow-hidden">
        ...
        <div class="w-64 bg-white shadow-lg border-r border-gray-200 flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                <!-- Dashboard -->
                <div>
                    <button wire:click="setActiveMenu('dashboard')"
                ...
                <!-- Users Management -->
                <div>
                    <button wire:click="toggleSubmenu('users')"
                    ...
                    <div class="submenu-enter {{ in_array('users', $openSubmenus) ? 'open' : '' }}">
                        <div class="ml-6 mt-2 space-y-1">
                            <button wire:click="setActiveMenu('users', 'all-users')"
                            ...
                            <button wire:click="setActiveMenu('users', 'add-user')"
                                class="w-full flex items-center px-3 py-2 text-sm rounded-lg transition-colors
                            ...
                            <button wire:click="setActiveMenu('users', 'user-roles')"
                                class="w-full flex items-center px-3 py-2 text-sm rounded-lg transition-colors
                ...
                <!-- Content Management -->
                <div>
                    <button wire:click="toggleSubmenu('content')"
                        class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg transition-colors menu-item-hover
                    ...
                    <div class="submenu-enter {{ in_array('content', $openSubmenus) ? 'open' : '' }}">
                        <div class="ml-6 mt-2 space-y-1">
                            <button wire:click="setActiveMenu('content', 'posts')"
                                class="w-full flex items-center px-3 py-2 text-sm rounded-lg transition-colors
                            ...
                            <button wire:click="setActiveMenu('content', 'pages')"
                                class="w-full flex items-center px-3 py-2 text-sm rounded-lg transition-colors
                            ...
                            <button wire:click="setActiveMenu('content', 'categories')"
                                class="w-full flex items-center px-3 py-2 text-sm rounded-lg transition-colors
                ...
                <div>
                    ...
                    <div class="submenu-enter {{ in_array('settings', $openSubmenus) ? 'open' : '' }}">
                        <div class="ml-6 mt-2 space-y-1">
                            <button wire:click="setActiveMenu('settings', 'general')"
                                class="w-full flex items-center px-3 py-2 text-sm rounded-lg transition-colors
                            ...
                            <button wire:click="setActiveMenu('settings', 'security')"
                                class="w-full flex items-center px-3 py-2 text-sm rounded-lg transition-colors
                ...
                <!-- Analytics -->
                <div>
                    <button wire:click="setActiveMenu('analytics')"
                        class="w-full flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors menu-item-hover
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <button
                                        class="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-orange-400 hover:bg-orange-50 transition-colors">
                                        <svg class="w-8 h-8 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
