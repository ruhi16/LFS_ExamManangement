    ...
    @if(!$this->user->teacher())
        <div class="flex items-center justify-center h-screen">
            <div class="text-center space-y-2">
                <p class="font-extrabold text-xl">This is Extra Bold</p>
                <p class="font-bold text-lg">This is Bold</p>
                <p class="font-normal text-base">This is Normal</p>
            </div>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 mt-4">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $answerScript->examClassSubject->subject->name ?? 'N/A' }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                {{-- <a href="{{ route('marks-entry.detail') }}"
                                    ...
                                    {{-- {{ $answerScript }} --}}
                                    {{-- {{ json_encode($answerScript->examClassSubject->subject_id ) }} --}}


                                <a class="text-indigo-600 hover:text-indigo-900"                                
                                    href="{{ route('marks-entry.detail', [
                                        'examDetailId' => $answerScript->exam_detail_id, 
                                        'subjectId' => $answerScript->examClassSubject->subject_id, 
                        ...
                        @empty
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-semibold text-blue-700 text-center" colspan="8">
