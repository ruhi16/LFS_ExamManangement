                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 align-top">
                        <td
                            ...
                            <div class="font-semibold">{{ $distribution->teacher ? $distribution->teacher->name : 'N/A'
                                }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 border-r border-gray-200">
                            <div class="font-semibold">{{ $distribution->examDetail &&
                                $distribution->examDetail->examName ? $distribution->examDetail->examName->name : 'N/A'
                                }}</div>
                        </td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 border-r border-gray-200">
                            <div class="font-semibold">{{ $distribution->examDetail &&
                                $distribution->examDetail->examType ? $distribution->examDetail->examType->name : 'N/A'
                                }}</div>
                        </td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 border-r border-gray-200">
                            <div class="font-semibold">{{ $distribution->examDetail &&
                                $distribution->examDetail->examMode ? $distribution->examDetail->examMode->name : 'N/A'
                                }}</div>
                        </td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 border-r border-gray-200">
                            <div class="font-semibold">{{ $distribution->myclassSection &&
                                $distribution->myclassSection->myclass ? $distribution->myclassSection->myclass->name :
                                'N/A' }}</div>
                        </td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 border-r border-gray-200">
                            <div class="font-semibold">{{ $distribution->myclassSection &&
                                $distribution->myclassSection->section ? $distribution->myclassSection->section->name :
                                'N/A' }}</div>
                        </td>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 border-r border-gray-200">
                        ...
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">
                            ...
                            <div class="flex items-center space-x-2">
                                <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('marks-entry.detail', [
                    ...
                    <tr class="hover:bg-gray-50 align-top">
                        ...
                        {{-- <td class="px-6 py-4">
                            @if($tDists->isEmpty())
                            <span
                                class="inline-block text-xs px-2 py-1 rounded bg-gray-100 text-gray-600 border border-gray-200">No
                                allotments</span>
                            @else
                            <div class="space-y-4">
                                ...
                                <div class="border border-gray-200 rounded-md">
                                    <div
                                        class="px-3 py-2 bg-gray-100 text-sm font-semibold text-gray-800 flex items-center gap-2">
                                        <span
                                            class="inline-block px-2 py-0.5 rounded bg-blue-200 text-blue-800 text-xs">Exam</span>
                                        <span>{{ $examName }}</span>
                                    </div>
                                    @php
                                    ...
                                    <div class="p-3 space-y-3">
                                        ...
                                        <div class="">
                                            <div class="text-sm font-medium text-gray-800 mb-1">
                                                <span
                                                    class="inline-block px-2 py-0.5 rounded bg-indigo-100 text-indigo-800 text-xs mr-2">Class-Section</span>
